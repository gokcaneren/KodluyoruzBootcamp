        ...
        static void Main(string[] args)
        {
            ...
            while (!isGameOver)
            {
                ...
                while (!isWordFinding || chance!=0)
                {
                        ...
                        {
                            chance--;
                            Console.WriteLine($"Yanlış harf tahmin ettiniz, {chance} hakkınız kaldı!");
                        }
                        ...
                        if (chance != 0)
                        {
                            ...
                            if (answerForGuess.ToUpper() == "E")
                            {
                                ...
                                if (isWordFinding)
                                {
                                    Console.WriteLine($"Tebrikler! Kelime:{selectedWord}");
                                break;
                                }
                                else
                                {
                                    chance--;
                                    Console.WriteLine($"Yanlış Kelime, {chance} hakkınız kaldı! ");
                                }
                            }
